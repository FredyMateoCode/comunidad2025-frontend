...
const timelineData = [
  { year: "1", 
    title: "PUBLICACIÓN",
    icon: "📆", color: "#f3bc0c", 
    description: "📆 16-02-2025 ✅"},

  { year: "2",
    title: "ENVÍO DE CURRICULM",
    icon: "📂", color: "#f34c0c",
    description: "📆 20-02-2025 ✅"},
...
const Tm009 = () => {
  ...
  return (
    ...
    <div className="timeline-container">
      <h1 className="text-center">Convocatoria N° 009</h1>
      <h2 className="text-center">01 Operador de Scoop II</h2>
